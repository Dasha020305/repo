...
namespace zadanie1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Уж не любит, меж цветов,");
            Console.WriteLine("Пахарь отдыхать порою");
            Console.WriteLine("От полуденных трудов.");
            Console.WriteLine("Зверь, отважный, поневоле");
